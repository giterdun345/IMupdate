const CompletedPage = () => {
  return (
    // SHOUT OUT TO https://codepen.io/brunab
    <div class="wrapper">
      <div class="screen">
        <svg class="clouds" viewBox="0 0 243 172">
          <defs>
            <linearGradient id="a" x1="0%" y1="21.631%" y2="78.369%">
              <stop offset="0%" stop-color="#cf34a5" />
              <stop offset="100%" stop-color="#8f34cf" />
            </linearGradient>
        ...
        <p class="message">
          Updated information sent successfully! We will contact you if we have
